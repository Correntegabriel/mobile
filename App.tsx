...
function Portifolio ({navigation}){
  return(
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.button} onPress={()=> Linking.openURL('mailto:correntegabriel80@gmail.com')}>
  ...
  return(
    <View style={styles.container}>
      ...
      <View style={{flex:1, alignItems:'flex-start'}}>
        ...
        <Text style={styles.skills}>Volei <Icon name="star" size={16} color="gold"/> <Icon name="star" size={16} color="gold"/> <Icon name="star" size={16} color="gold"/> <Icon name="star" size={16} color="gold"/> <Icon name="star" size={16} color="gold"/></Text>
        <Text style={styles.skills}>cozinheiro<Icon name="star" size={16} color="gold"/> <Icon name="star" size={16} color="gold"/> <Icon name="star" size={16} color="gold"/> <Icon name="star" size={16} color="gold"/> <Icon name="star" size={16} color="gold"/></Text>
      
      <TouchableOpacity style={styles.buttonSkill} onPress={()=> Linking.openURL('https://wa.me/<5543996816850>')}>
